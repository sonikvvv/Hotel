...
public class FillDB {
    public void filldb() {
        ...
        Room r1 = new Room("73", "r_type", 633.00, SE.FREE, h1);
        Room r2 = new Room("64", "r_type", 52.00, SE.FREE, h1);
        Room r3 = new Room("3", "r_type", 680.00, SE.FREE, h1);
        Room r4 = new Room("63", "r_type", 469.00, SE.FREE, h1);
        Room r5 = new Room("69", "r_type", 547.00, SE.FREE, h1);
        Room r6 = new Room("42", "r_type", 976.00, SE.FREE, h1);
        Room r7 = new Room("25", "r_type", 232.00, SE.FREE, h1);
        Room r8 = new Room("18", "r_type", 782.00, SE.FREE, h1);
        Room r9 = new Room("73", "r_type", 227.00, SE.FREE, h1);
        Room r10 = new Room("87", "r_type", 716.00, SE.FREE, h1);
        Room r11 = new Room("17", "r_type", 764.00, SE.FREE, h1);
        Room r12 = new Room("42", "r_type", 818.00, SE.FREE, h1);
        Room r13 = new Room("100", "r_type", 880.00, SE.FREE, h1);
        Room r14 = new Room("82", "r_type", 780.00, SE.FREE, h1);
        Room r15 = new Room("96", "r_type", 810.00, SE.FREE, h1);
        Room r16 = new Room("10", "r_type", 801.00, SE.FREE, h1);
        Room r17 = new Room("24", "r_type", 830.00, SE.FREE, h1);
        Room r18 = new Room("98", "r_type", 394.00, SE.FREE, h1);
        Room r19 = new Room("70", "r_type", 569.00, SE.FREE, h1);

        Room r20 = new Room("99", "r_type", 442.00, SE.FREE, h2);
        Room r21 = new Room("49", "r_type", 537.00, SE.FREE, h2);
        Room r22 = new Room("17", "r_type", 411.00, SE.FREE, h2);
        Room r23 = new Room("4", "r_type", 739.00, SE.FREE, h2);
        Room r24 = new Room("79", "r_type", 356.00, SE.FREE, h2);
        Room r25 = new Room("52", "r_type", 274.00, SE.FREE, h2);
        Room r26 = new Room("29", "r_type", 106.00, SE.FREE, h2);
        Room r27 = new Room("45", "r_type", 166.00, SE.FREE, h2);
        Room r28 = new Room("23", "r_type", 503.00, SE.FREE, h2);
        Room r29 = new Room("37", "r_type", 849.00, SE.FREE, h2);
        Room r30 = new Room("62", "r_type", 445.00, SE.FREE, h2);
        Room r31 = new Room("73", "r_type", 889.00, SE.FREE, h2);
        Room r32 = new Room("9", "r_type", 754.00, SE.FREE, h2);
        Room r33 = new Room("63", "r_type", 640.00, SE.FREE, h2);
        Room r34 = new Room("36", "r_type", 647.00, SE.FREE, h2);
        Room r35 = new Room("89", "r_type", 958.00, SE.FREE, h2);
        Room r36 = new Room("67", "r_type", 47.00, SE.FREE, h2);
        Room r37 = new Room("22", "r_type", 990.00, SE.FREE, h2);
        Room r38 = new Room("70", "r_type", 219.00, SE.FREE, h2);
        Room r39 = new Room("11", "r_type", 666.00, SE.FREE, h2);
        ...
        ReservationForm rf1 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-01-11"), LocalDate.parse("2020-11-13"), 4, 3, 0, "food_type", 552.00, "status", "notes", "Einar Koss");
        ReservationForm rf2 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-07-17"), LocalDate.parse("2020-11-20"), 2, 2, 0, "food_type", 16.00, "status", "notes", "Dr. Arlo Hegmann");
        ReservationForm rf3 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-07-14"), LocalDate.parse("2020-12-16"), 1, 4, 0, "food_type", 339.00, "status", "notes", "Claire Moen");
        ReservationForm rf4 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-05-15"), LocalDate.parse("2020-10-19"), 3, 2, 0, "food_type", 218.00, "status", "notes", "Lelah Mann DVM");
        ReservationForm rf5 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-02-12"), LocalDate.parse("2020-11-20"), 3, 5, 0, "food_type", 581.00, "status", "notes", "Reyna Nienow");
        ReservationForm rf6 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-09-16"), LocalDate.parse("2020-10-17"), 1, 2, 0, "food_type", 875.00, "status", "notes", "Mrs. Destinee Hermann");
        ReservationForm rf7 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-06-15"), LocalDate.parse("2020-10-15"), 4, 5, 0, "food_type", 353.00, "status", "notes", "Nathanael Weber");
        ReservationForm rf8 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-09-12"), LocalDate.parse("2020-12-11"), 2, 2, 0, "food_type", 117.00, "status", "notes", "Rosalyn Thiel");
        ReservationForm rf9 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-05-17"), LocalDate.parse("2020-11-14"), 4, 2, 0, "food_type", 820.00, "status", "notes", "Laverna Carroll");
        ReservationForm rf10 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-02-14"), LocalDate.parse("2020-10-14"), 3, 3, 0, "food_type", 570.00, "status", "notes", "Katrine Little");
        ReservationForm rf11 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-05-15"), LocalDate.parse("2020-11-19"), 4, 5, 0, "food_type", 53.00, "status", "notes", "Norberto Baumbach");
        ReservationForm rf12 = new ReservationForm("reservation_type", "room_type", "cancel_type", LocalDate.parse("2020-04-19"), LocalDate.parse("2020-12-15"), 3, 2, 0, "food_type", 986.00, "status", "notes", "Riley Rolfson");
